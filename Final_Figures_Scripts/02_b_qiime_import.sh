...
qiime tools import \
--input-path $clusterDir/phy_data_rare_features-table.biom \
--type 'FeatureTable[Frequency]' \
--input-format BIOMV100Format \
--output-path $wkdir/phy_data_rare_features-table.qza


qiime tools import \
--input-path $clusterDir/phy_data_rare_tree-rooted.newick \
--type 'Phylogeny[Rooted]' \
--output-path $wkdir/phy_data_rare_tree-rooted.qza
